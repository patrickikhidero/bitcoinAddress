...
txb.addOutput('tb1py3gfzfylfu5axzpquheku8jaga7uxwrpgs3qh4hntqu7jn0yh89qh97gmu', keyPair.getAddress(),  
    keyPair.getAddress(), satoshisToSend - fee);
...
txb2.addInput(prevTxHash, prevTxIndex);
txb2.addOutput('tb1py3gfzfylfu5axzpquheku8jaga7uxwrpgs3qh4hntqu7jn0yh89qh97gmu',  
    satoshisToSend - fee);

txb2.sign(0, keyPair, Buffer.from(unlockingScriptHex, 'hex'));
